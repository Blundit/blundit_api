class Claim < ApplicationRecord
    ...
    has_attached_file :pic, styles: { medium: "300x300>", thumb: "100x100>" }, path: ":rails_root/public/images/claim_avatars/:id/:basename.:extension", default_url: "/images/avatars/placeholder.png"
